...
import xyz.illuminate.git.avatar.AvatarDownloader;
...
public class SheimiFragmentActivity extends AppCompatActivity {
    ...
    private void promptForPasswordInner(
        ...
        builder.setTitle(errorInfo)
                .setView(layout)
                .setPositiveButton(R.string.label_done, (dialogInterface, i) -> onPasswordEntered.onClicked(username.getText()
                        .toString(), password.getText()
                        .toString(), checkBox.isChecked()))
                .setNegativeButton(R.string.label_cancel, (dialogInterface, i) -> onPasswordEntered.onCanceled()).show();
    }
