package xyz.illuminate.git.adapters;
...
public class FilesListAdapter extends ArrayAdapter<File> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item.isDirectory()) {
            holder.fileIcon.setImageResource(Profile.getStyledResource(getContext(), R.drawable.ic_folder));
        } else {
            holder.fileIcon.setImageResource(Profile.getStyledResource(getContext(), R.drawable.ic_file));
        }
        // set if selected
