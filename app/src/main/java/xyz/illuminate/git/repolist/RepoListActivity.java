...
import xyz.illuminate.git.ViewHelperKt;
import xyz.illuminate.git.activities.RepoDetailActivity;
import xyz.illuminate.git.activities.SheimiFragmentActivity;
import xyz.illuminate.git.activities.UserSettingsActivity;
import xyz.illuminate.git.activities.explorer.ExploreFileActivity;
import xyz.illuminate.git.activities.explorer.ImportRepositoryActivity;
import xyz.illuminate.git.adapters.RepoListAdapter;
import xyz.illuminate.git.clone.CloneViewModel;
import xyz.illuminate.git.common.OnActionClickListener;
import xyz.illuminate.git.database.RepoDbManager;
import xyz.illuminate.git.database.models.Repo;
import xyz.illuminate.git.databinding.ActivityMainBinding;
import xyz.illuminate.git.dialogs.DummyDialogListener;
import xyz.illuminate.git.dialogs.ImportLocalRepoDialog;
import xyz.illuminate.git.repo.tasks.repo.CloneTask;
import xyz.illuminate.git.ssh.PrivateKeyUtils;
import xyz.illuminate.git.transport.MGitHttpConnectionFactory;
